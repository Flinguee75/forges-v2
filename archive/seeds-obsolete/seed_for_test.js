...
async function seed() {
  ...
  await prisma.abonnementB2B.create({ data: {
    id: IDS.abo_b2b_01,
    palier: 'STARTER',
    nb_apprenants_max: 20,
    nb_apprenants_actifs: 5,
  ...
  // ── 3. PARTENAIRE ─────────────────────────────────────────
  console.log('  3/11 Partenaire Institut Tech Test CI...');
  ...
  await prisma.voucherOrganisation.createMany({ skipDuplicates: true, data: [
    {
      id: IDS.vch_org_01,
      code: 'VCH-ORG-01',
  ...
  await prisma.commissionApporteur.createMany({ data: [
    {
      id: uuidv4(), apporteur_id: IDS.apporteur,
      montant_base_xof: 40000, taux_commission_pct: 5, montant_commission_xof: 2000,
      date_generation: agoD(20), mois_facturation: moisCourant,
      statut: 'EN_ATTENTE', created_at: agoD(20),
    },
    // Deux autres commissions en attente — cumul total 4500 XOF (< 5000 seuil)
    {
      id: uuidv4(), apporteur_id: IDS.apporteur,
      montant_base_xof: 50000, taux_commission_pct: 5, montant_commission_xof: 2500,
      date_generation: agoD(15), mois_facturation: moisCourant,
      statut: 'EN_ATTENTE', created_at: agoD(15),
    },
  ]});
