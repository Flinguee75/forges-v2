...
9. Tu veux enrôler des apprenants déjà créés depuis un CSV avec une colonne voucher, en ciblant explicitement la formation et la session: `scripts/enrolements/creer-apprenants-avec-voucher.ts`.
10. Tu veux tester l'envoi du reçu PDF de paiement vers un dossier confirmé: `scripts/test-recu-email.ts`.
...
| Workflow CSV apprenants avec voucher | `scripts/enrolements/creer-apprenants-avec-voucher.ts` (formation/session requis) |
