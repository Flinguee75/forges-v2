...
- `script_organisations_point_focal.ts` sert au workflow complet de test pour une organisation avec apprenants, devis et vouchers.
...
| `script_organisations_point_focal.ts` | Workflow complet de test | Scénario Point Focal / vouchers |
...
- Utiliser `script_organisations_point_focal.ts` uniquement quand on veut rejouer le parcours complet de facturation organisation.
