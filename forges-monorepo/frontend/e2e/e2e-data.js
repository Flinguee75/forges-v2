export const E2E_ACCOUNTS = {
  ...
  responsable: {
    email: 'responsable-e2e@forges.ci',
    password: 'Test@FORGES2026!',
  },
  superviseur: {
    email: 'superviseur-e2e@forges.ci',
    password: 'Test@FORGES2026!',
  },
  agent: {
    email: 'agent-e2e@forges.ci',
    password: 'Test@FORGES2026!',
  },
  apprenant: {
  ...
  apprenantRm145: {
    email: 'apprenant-rm145@forges.ci',
    password: 'Test@FORGES2026!',
  },
  apprenantStd: {
    email: 'apprenant-std-e2e@forges.ci',
    password: 'Test@FORGES2026!',
  },
  apprenantPremiumRetail: {
    email: 'apprenant-premium-retail-e2e@forges.ci',
    password: 'Test@FORGES2026!',
  },
  apprenantPremiumB2b: {
    email: 'apprenant-premium-b2b-e2e@forges.ci',
    password: 'Test@FORGES2026!',
  },
  apprenantDossier: {
    email: 'apprenant-dossier-e2e@forges.ci',
    password: 'Test@FORGES2026!',
  },
  apprenantAuth: {
...
export const E2E_SCENARIO = {
  formationId: 'F-E2E-STD-01',
  sessionId: 'S-E2E-STD-OPEN-01',
  standardFormationId: 'F-E2E-STD-01',
  standardSessionId: 'S-E2E-STD-OPEN-01',
  premiumRetailFormationId: 'F-E2E-PREM-RETAIL-01',
  premiumRetailSessionId: 'S-E2E-PREM-RETAIL-OPEN-01',
  ...
  sessionPlanifieeId: 'S-E2E-PLANIFIEE-01',
  sessionAVenirId: 'S-E2E-A-VENIR-01',
  sessionOuverteId: 'S-E2E-OUVERTE-01',
  sessionEnCoursId: 'S-E2E-EN-COURS-01',
  ...
  dossierAnnulableId: 'D-E2E-ANNULABLE-01',
